...
function CritBar.new(window)
  ---@type CritBar
  local self = {
    consoleFront = Image.new({ path = "gameplay/console/front.png" }),
    fill = Image.new({ path = "gameplay/crit_bar/fill.png" }),
    flickerTimer = 0,
    overlay = Image.new({ path = "gameplay/crit_bar/overlay.png" }),
    window = window,
  }
